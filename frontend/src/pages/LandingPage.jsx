                ...
                <div className={landingPageStyles.headerContainer}>
                    <div className={landingPageStyles.logoContainer}>
                        <div className={landingPageStyles.logoIcon}>
                            <LuLayoutTemplate className={landingPageStyles.logoIconInner} />
                        </div>
                    ...
                    <button className={landingPageStyles.mobileMenuButton}
                        ...
                        {
                            mobileMenuOpen ?
                                <RxCross2 size={24} className={landingPageStyles.mobileMenuIcon} /> :
                                < IoMenuOutline size={24} className={landingPageStyles.mobileMenuIcon} />
                        }
                    </button>
            ...
            <main className={landingPageStyles.main}>
                    ...
                    <div className={landingPageStyles.heroGrid}>
                        ...
                        <div className={landingPageStyles.heroLeft}>
                            ...
                            <p className={landingPageStyles.description}>
                                Create job-winning resumes in minutes with our easy-to-use, customizable templates.
                            </p>
                            <div className={landingPageStyles.ctaButtons}>
                                <button className={landingPageStyles.primaryButton} onClick={handleCTA}>
                                    ...
                                    <span className={landingPageStyles.primaryButtonContent}>
                                        Start Building
                                        <FaArrowRight className={landingPageStyles.primaryButtonIcon} size={18} />
                                    </span>
                                </button>
                ...
                <section className={landingPageStyles.featuresSection}>
                    <div className={landingPageStyles.featuresContainer}>
                        <div className={landingPageStyles.featuresHeader}>
                            ...
                            <p className={landingPageStyles.featuresDescription}>
                                Resume Builder is the perfect tool for creating professional resumes quickly and easily. With a user-friendly interface and a variety of templates to choose from, you can create a standout resume in no time.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={landingPageStyles.featuresGrid}>
                        {[
                            {
                                icon: <LuZap className={landingPageStyles.featureIcon} />,
                            ...
                            {
                                icon: <LuLayoutTemplate className={landingPageStyles.featureIcon} />,
                                title: "Pro Templates",
                            ...
                            {
                                icon: <LuDownload className={landingPageStyles.featureIcon} />,
                        ...
                        <div className={landingPageStyles.ctaCard}>
                            ...
                            <div className={landingPageStyles.ctaCardContent}>
                                <h2 className={landingPageStyles.ctaTitle}>
                                    Ready to Build Your <span className={landingPageStyles.ctaTitleGradient}>Dream Resume?</span>
                                </h2>
                                <p className={landingPageStyles.ctaDescription}>
                                    Sign up now and create your professional resume in minutes!
                                </p>
            ...
            <footer className={landingPageStyles.footer}>
                <div className={landingPageStyles.footerContainer}>
                    <p className={landingPageStyles.footerText}>
                        Crafted with <span className={landingPageStyles.footerHeart}>❤️</span> by{' '} <a href="" target='_self' className={landingPageStyles.footerLink}>Resume Builder</a>
                    </p>
                </div>
            </footer>
